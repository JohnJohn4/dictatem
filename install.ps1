...
#
# This installs Dictatem pinned to the v0.5.7 release (the line marked below)
...
# so no git and no compiler are needed. Pinned to the v0.5.7 release for an
# auditable, reproducible install; when cutting a new release, bump this tag AND
# the README one-liner URL.
$source = 'https://github.com/JohnJohn4/dictatem/archive/refs/tags/v0.5.7.tar.gz'
